...
original=cv2.imread('/home/yuto/Documents/AIhub/nanoimage/11_Morphology_Transform_A.png',cv2.IMREAD_GRAYSCALE)

dot=cv2.imread('/home/yuto/Documents/AIhub/nanoimage/11_Morphology_Transform_B.png',cv2.IMREAD_GRAYSCALE)

hole=cv2.imread('/home/yuto/Documents/AIhub/nanoimage/11_Morphology_Transform_C.png',cv2.IMREAD_GRAYSCALE)
...
blackhat=cv2.morphologyEX(th_o,cv2.MORPH_OPEN,kernel)

images=[th_d,erosion,opening,th_h,dilation, closing,gradient,tophat,blackhat]
titles=['Dot images','erosion','hole image','dilation','closing','gradient','tophat','blackhot']

fig=plt.figure()
fig.canvas.manager.set_window_title('JetsonNano_Morphological_Transformations')
